...
1. Explain the difference between Relational Databases and SQL.
       SQL which stands for Structured Query Language is used to manipulate data and A relational database is used to show the structure of that data  
2. Why do tables need a Primary Key?
      To uniquely show identify every record in a table
3. What is the name given to a table column that references the Primary Key on another table?
    A foreign Key 
4. What do we need in order to have a _many to many_ relationship between two tables?
    A mariage table or junction table to store the primary key as foreign keys in a third table
